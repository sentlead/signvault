              ...
              {magicLinkSent ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {/* Apple button — coming soon, not yet configured */}
                    <div className="relative group">
                      ...
                      >
                        ...
                        Continue with Apple
                        <span className="ml-auto text-[10px] font-semibold tracking-wide
                                         text-white/40 dark:text-white/25 uppercase">
                          Soon
                        </span>
                      </button>
                      {/* Tooltip on hover */}
                      <div className="
                        ...
                        px-3 py-1.5 rounded-lg text-xs text-white bg-gray-900 dark:bg-gray-700
